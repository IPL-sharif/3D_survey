...
* **Discrete-continuous optimization for large-scale structure from motion**, CVPR 2011, [ :link: ](https://ieeexplore.ieee.org/document/5995634)
...
* **Towards linear-time incremental structure from motion**, 3DV 2013, [ :link: ](https://ieeexplore.ieee.org/document/6599035)
...
* **Fast-mvsnet: Sparse-to-dense multi-view stereo with learned propagation and gauss-newton refinement**, CVPR 2020, [ :link: ](https://openaccess.thecvf.com/content_CVPR_2020/papers/Yu_Fast-MVSNet_Sparse-to-Dense_Multi-View_Stereo_With_Learned_Propagation_and_Gauss-Newton_CVPR_2020_paper.pdf)
...
* **Nerfplayer: A streamable dynamic scene representation with decomposed neural radiance fields**, IEEE TVCG 2023, [ :link: ](https://ieeexplore.ieee.org/document/10089737)
...
* **Instant neural graphics primitives with a multiresolution hash encoding**, ACM Trans. Graph. 2022, [ :link: ](https://doi.org/10.1145/3528223) [ :octocat: ](https://github.com/NVlabs/instant-ngp)
...
* **Neural sparse voxel fields**, NeurIPS 2020, [ :link: ](https://proceedings.neurips.cc/paper/2020/hash/c7f85c4ea6fc4c7c5c73462f2fce3b1b-Abstract.html) [ :octocat: ](https://github.com/facebookresearch/NSVF)
...
* **Lightgaussian: Unbounded 3d gaussian compression with 15x reduction and 200+ fps**, NeurIPS 2024, [ :link: ](https://proceedings.neurips.cc/paper_files/paper/2024/hash/68d64cc0f592c640f9a1ebf2d5aa3d45-Abstract.html)
...
* **Gaussian opacity fields: Efficient adaptive surface reconstruction in unbounded scenes**, ACM Trans. Graph. 2024, [ :link: ](https://dl.acm.org/doi/10.1145/3687911)
...
* **Surface reconstruction from 3d gaussian splatting via local structural hints**, ECCV 2024, [ :link: ](https://link.springer.com/chapter/10.1007/978-3-031-73239-5_24)
