...
* **SparseVoxFormer: Sparse Voxel-based Transformer for Multi-modal 3D Object Detection**, arXiv 2025, [ :link: ](https://arxiv.org/abs/2503.08092) [ :octocat: ](https://github.com/open-mmlab/mmdetection3d) *(no official repo found)*
* **SVEFusion: Beyond Pillars… Salient Voxel Enhancement of LiDAR–4D Radar Fusion**, Pattern Recognition 2026, [ :link: ](https://www.sciencedirect.com/science/article/pii/S0031320325015043) [ :octocat: ](https://github.com/icdm-adteam/SVEFusion)
#### pillar-based
...
* **3D-CVF: Cross-View Spatial Feature Fusion**, ECCV 2020, [ :link: ](https://arxiv.org/abs/2007.16160) [ :octocat: ](https://github.com/rasd3/3D-CVF)
* **CVFNet: Real-time 3D Object Detection by Learning Cross View Features**, IROS 2022, [ :link: ](https://arxiv.org/abs/2203.06585) [ :octocat: ](https://github.com/open-mmlab/mmdetection3d) *(no official repo found)*
...
* **Bridged Transformer for Vision and Point Cloud 3D Object Detection**, CVPR 2022, [ :link: ](https://openaccess.thecvf.com/content/CVPR2022/papers/Wang_Bridged_Transformer_for_Vision_and_Point_Cloud_3D_Object_Detection_CVPR_2022_paper.pdf) [ :octocat: ](https://github.com/open-mmlab/mmdetection3d) *(no official repo found)*
...
* **GAFusion: Adaptive Fusing LiDAR and Camera with Multiple Guidance for 3D Object Detection**, CVPR 2024, [ :link: ](https://openaccess.thecvf.com/content/CVPR2024/papers/Li_GAFusion_Adaptive_Fusing_LiDAR_and_Camera_with_Multiple_Guidance_for_CVPR_2024_paper.pdf) [ :octocat: ](https://github.com/open-mmlab/mmdetection3d) *(no official repo found)*
* **RCBEVDet: Radar-camera Fusion in Bird’s Eye View for 3D Object Detection**, CVPR 2024, [ :link: ](https://openaccess.thecvf.com/content/CVPR2024/papers/Lin_RCBEVDet_Radar-camera_Fusion_in_Birds_Eye_View_for_3D_Object_CVPR_2024_paper.pdf) [ :octocat: ](https://github.com/VDIGPKU/RCBEVDet) *(access-controlled)*
...
* **L4DR: LiDAR-4DRadar Fusion for Weather-Robust 3D Object Detection**, AAAI 2025, [ :link: ](https://arxiv.org/abs/2408.03677) [ :octocat: ](https://github.com/ylwhxht/L4DR)
...
* **V2X-R: Cooperative LiDAR–4D Radar Fusion…**, CVPR 2025, [ :link: ](https://arxiv.org/abs/2411.08402) [ :octocat: ](https://github.com/ylwhxht/V2X-R)
* **Doppler-Aware LiDAR–RADAR Fusion for Weather-Robust 3D Detection (DLRFusion)**, ICCV 2025, [ :link: ](https://openaccess.thecvf.com/content/ICCV2025/papers/Chae_Doppler-Aware_LiDAR-RADAR_Fusion_for_Weather-Robust_3D_Detection_ICCV_2025_paper.pdf) [ :octocat: ](https://github.com/open-mmlab/mmdetection3d) *(no official repo found)*
* **Height-Fidelity Dense Global Fusion for Multi-modal 3D Object Detection**, ICCV 2025, [ :link: ](https://openaccess.thecvf.com/content/ICCV2025/papers/Wang_Height-Fidelity_Dense_Global_Fusion_for_Multi-modal_3D_Object_Detection_ICCV_2025_paper.pdf) [ :octocat: ](https://github.com/AutoLab-SAI-SJTU/MambaFusion)
* **PV-DT3D: Point-voxel Dual Transformer for LiDAR 3D Object Detection**, Optoelectronics Letters 2025, [ :link: ](https://link.springer.com/article/10.1007/s11801-025-3134-9) [ :octocat: ](https://github.com/open-mmlab/OpenPCDet) *(no official repo found)*
